...
const socialIcons = [
  { href: 'https://github.com/tado3002', icon: Github },
  { href: '', icon: LinkedIn },
  { href: '', icon: Codepen },
  { href: '', icon: X },
  { href: 'https://www.instagram.com/tdh.schwarzen/', icon: Instagram },
  { href: '', icon: Facebook },
]

const footerSections = [
  { title: 'tdh.schwarzen', href: '#home', content: 'Crafting high-performance web applications.' },
  ...
  <footer id="contact" className="bg-secondary px-4 text-white md:px-0">
    ...
    <div className="mx-auto max-w-[1200px] px-4 py-8">
      <div className="flex flex-col items-center justify-between md:flex-row">
        <p className="mb-4 text-sm font-normal md:mb-0">© 2025 Muhammad Murtadlo | Coded with 💜</p>
